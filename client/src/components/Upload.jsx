...
const Upload = () => {
  return (
    <div className=''>
        <h1 className = 'text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-400 bg-clip-text text-transparent py-6 md:py-16'>See the magic. Try Now</h1>
